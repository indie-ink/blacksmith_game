...
const ICON_BY_STAGE: Dictionary[GameManager.CraftingStage, Resource] = {
	GameManager.CraftingStage.IDLE: preload("res://Assets/Sprites/4 Icons/SieveIcon.png"),
	GameManager.CraftingStage.SIEVE: preload("res://Assets/Sprites/4 Icons/FurnaceIcon.png"),
